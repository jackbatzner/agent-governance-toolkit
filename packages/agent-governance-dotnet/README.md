...
DID-based agent identity with cryptographic signing (HMAC-SHA256, ML-DSA post-quantum on .NET 10+):
...
On .NET 10, ML-DSA-65 (NIST FIPS 204) provides quantum-resistant asymmetric signing:
...
| Message signing | — | ✅ HMAC-SHA256 + ML-DSA-65 (PQ) + replay |
| Response scanning | — | ✅ Injection + exfiltration |
| Credential redaction | — | ✅ 10 patterns |
| OWASP MCP coverage | — | ✅ 11/12 sections |
...
- .NET 8.0 or .NET 10.0 (multi-targeted)
  ...
  - .NET 10: Adds ML-DSA-65 post-quantum asymmetric signing (NIST FIPS 204)
